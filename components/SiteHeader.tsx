    ...
    <header className="sticky top-0 z-20 border-b border-line-light bg-background-light/88 backdrop-blur-md dark:border-line-dark dark:bg-background-dark/90">
      <div className="mx-auto flex h-16 w-full max-w-[1180px] items-center justify-between gap-3 px-5 sm:h-[72px] sm:px-7">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <Link
            href="/categories"
            className="rounded-full bg-accent-sage px-4 py-2 font-sans text-xs font-semibold text-white shadow-editorial-sm transition hover:bg-primary-700 dark:bg-primary-400 dark:text-gray-950 dark:hover:bg-primary-300 sm:px-5 sm:text-sm"
          >
            开始阅读
          </Link>
          <ThemeToggle />
