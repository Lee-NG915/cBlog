...
import TheCastleryClubLayoutClient from './layout.client';
...
// 账户模块布局 - 使用新的响应式侧边栏
export default function TheCastleryClubLayout({ children, params }: AccountLayoutProps) {
  return (
    <SentryContextProvider pageType={PAGE_TYPES.OTHER} domain={BUSINESS_DOMAIN.USER}>
      <WebMainLayout>
        <TheCastleryClubLayoutClient>{children}</TheCastleryClubLayoutClient>
      </WebMainLayout>
