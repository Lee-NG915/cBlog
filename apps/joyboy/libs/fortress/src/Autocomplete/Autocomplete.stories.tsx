...
export function AlwaysOpenDropdown() {
  const [value, setValue] = React.useState<FilmOptionType | null>(null);

  return (
    <FormControl id="always-open-demo">
      <FormLabel>Always Open Dropdown (常驻下拉框)</FormLabel>
      <Autocomplete
        value={value}
        onChange={(event, newValue) => setValue(newValue)}
        open={true} // 强制打开
        options={top100Films.slice(0, 10)} // 只显示前10个选项
