...
import { TrackableLink, TrackableLinkProps } from './TrackableLink';
import type { Meta, StoryObj } from '@storybook/react';
import { within, expect } from '@storybook/test';
/**
 * Storybook story for the TrackableLink component.
 * Dev Doc  https://castlery.atlassian.net/wiki/spaces/EC/pages/2866872410/CDD
 * This component renders a TrackableLink and demonstrates its default usage.
 */
...
const meta = {
  ...
  play: commonPlay,
} as Meta<TrackableLinkProps>;

export default meta;

type Story = StoryObj<TrackableLinkProps>;

export const Primary: Story = {
  render: (args) => <TrackableLink {...args} />,
};
