...
export const DELIVERY_DATA = {
  ...
  description: 'Skip the wait for select items.',
...
export const WARRANTY_DATA = {
  title: 'Up to 10-yr. guarantee',
  description: 'On select sofas, beds, and more; up to one year on everything else.',
  guideLinkRichText: <RichText content={`<a href=${SERVICE_LINK.guarantee} target="_blank">Terms & Conditions</a> apply`} />,
};
