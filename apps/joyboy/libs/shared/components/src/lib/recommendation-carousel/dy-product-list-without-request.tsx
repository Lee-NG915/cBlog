...
interface RecommendationCarouselWithoutRequestProps {
...
const DYRecommendationCarouselWithoutRequest = ({
  selector_name,
  campaign,
  onClick,
  fallbackWidget,
...
}: RecommendationCarouselWithoutRequestProps) => {
...
export { DYRecommendationCarouselWithoutRequest };
