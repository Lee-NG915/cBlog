...
- `pnpm dlx storybook@latest automigrate --config-dir apps/pos-e2e/.storybook`

- `pnpm dlx storybook@latest automigrate --config-dir apps/web-e2e/.storybook`

- `pnpm dlx storybook@latest automigrate --config-dir libs/fortress/.storybook`

- `pnpm dlx storybook@latest automigrate --config-dir libs/storybook-host/.storybook`
