...
export interface ExtendStepTypeMap<M extends OverridableTypeMap> {
  props: M['props'] & StepProps;
  defaultComponent: M['defaultComponent'];
}

export type ExtendStep<M extends OverridableTypeMap> = ((
  props: OverrideProps<ExtendStepTypeMap<M>, 'div'>
) => JSX.Element) &
  OverridableComponent<ExtendStepTypeMap<M>>;
