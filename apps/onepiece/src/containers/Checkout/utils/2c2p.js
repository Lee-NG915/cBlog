...
My2c2p.getEncryptedData = function (a, b) {}, My2c2p.onSubmitFormWithReturn = function (a, b, c) {
  var d = this,
    e = __INSTALMENT_ENCRYPT__,
    f = function (a) {
      var b = [],
        c = 0;
      for (c = 0; c < a.children.length; c++) child = a.children[c], 1 === child.nodeType && child.attributes["data-encrypt"] ? b.push(child) : (child.children && child.children.length > 0) && (b = b.concat(f(child)));
      return b
    },
    g = function (a) {
      for (var b = {
        ...
        "cardnumber" == g ? b.cardnumber = e.replace(/ /g, '').trim() : "cvv" == g ? b.cvv = e : "month" == g ? b.month = e : "year" == g && (b.year = e)
      }
      return b
    },
    j = function () {
    ...
    n = function (a, b, c) {
      ...
      d.length > 0 && "undefined" != typeof a.elements.namedItem(b) && null != a.elements.namedItem(b) && a.removeChild(d[0]);
...
module.exports = My2c2p;
/* eslint-enable */

/**
 *
 * Changes:
 *   1: ["undefined" != typeof module ? module.exports = f : window.ASN1 = f] => [window.ASN1 = f]
 *   2: ["object" == typeof exports ? module.exports = b() : "function" == typeof define && define.amd ?
 *     define(b) : a.GibberishAES = b()] => [a.GibberishAES = b()]
 *   3: (this, function ...) => (window, function ...)
 *   4: remove console.log(a.elements.namedItem(b))
 *   5: add module.exports = My2c2p
 *   6: [b.cardnumber = e] => [b.cardnumber = e.replace(/ /g, '').trim()]
 *   7: child.children.length > 0 => child.children && child.children.length > 0
 */
