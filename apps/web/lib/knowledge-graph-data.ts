...
> = {
  ...
  module: {
    label: "模块层",
    description: "跨域基础设施：迁移、特性开关、可观测性、设计系统",
  },
  domain: {
    label: "业务域",
...
export const DOMAIN_META: DomainMeta[] = [
  ...
  },
  {
    id: "platform",
    label: "平台能力",
    description: "i18n、鉴权、Feature Flag 与多市场能力",
    docCount: 6,
    color: "#6B7280",
  },
];
...
export const KNOWLEDGE_NODES: KnowledgeNode[] = [
  {
    ...
    hubAnchor: "一、架构与边界治理",
    relatedIds: ["mod-platform", "impl-isr", "impl-errors"],
  },
  {
    id: "arch-client",
    label: "客户端架构",
    ...
    relatedIds: ["mod-design", "mod-migration", "dom-transaction"],
  },
  {
    id: "mod-migration",
    label: "大规模迁移",
  ...
  },
  {
    ...
    layer: "module",
    domain: "platform",
    summary: "i18n、鉴权、Feature Flag、环境隔离等横向能力。",
    relatedIds: ["arch-multimarket", "impl-errors"],
  },
  {
  ...
  },
  {
    ...
    layer: "domain",
    domain: "platform",
    summary: "登录、权限、token 刷新与服务端鉴权预判。",
    blogSlug: "edge-middleware-auth-design",
    relatedIds: ["arch-client", "impl-errors"],
  },
  {
    id: "impl-isr",
    label: "ISR + 共享缓存",
    ...
    relatedIds: ["arch-multimarket", "mod-platform"],
  },
  {
