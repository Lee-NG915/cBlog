...
import { getAllRightCapitalNotes } from "@/lib/rightCapital";

export const metadata: Metadata = {
  title: "RightCapital 面试笔记",
  robots: {
    index: false,
    follow: false,
  },
...
export default function RightCapitalIndexPage() {
  const notes = getAllRightCapitalNotes();
    ...
    <div className="space-y-8">
      <header data-reveal="hero">
        ...
        <p className="mt-4 max-w-2xl font-sans text-base leading-7 text-ink-muted dark:text-gray-300">
          针对 RightCapital 面试准备的笔记目录，仅通过手动输入路由访问。
        </p>
      </header>
