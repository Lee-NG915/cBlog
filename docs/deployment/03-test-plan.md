...
| Phase 5 | WEB-206、STATIC P0、ISR P0、SEO P0、PERF-201（STATIC-002/004/005/006 的 Outbox 自动触发 dispatch、事件合并批次与 deployment 状态机属 Phase 6 范围——02-implementation-plan §4 Phase 6，本章以接收端 + 脚本化触发验证链路，自动触发随 Phase 6 验证） |
